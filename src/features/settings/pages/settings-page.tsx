import { User, Shield, Monitor, Palette, Info, Globe } from 'lucide-react';
  ...
  return (
    <Card>
      ...
      <CardContent className="space-y-0">
        {items.map((item, i) => (
          <div key={item.label}>
            <div className="flex items-center gap-3 py-3 cursor-pointer hover:bg-accent -mx-4 px-4 rounded-xl transition-colors">
...
export function SettingsPage() {
  ...
  const settingsSections: { title: string; items: SettingsItem[] }[] = [
    ...
    },
    {
      ...
      items: [
        { icon: Info, label: t('items.about'), description: t('items.aboutDesc') },
      ],
    },
  ];
