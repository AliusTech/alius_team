...
import { Bot, Bell, CheckCircle2, Trash2 } from 'lucide-react';
...
export function NotificationItem({ notification, locale, onOpen, onDelete }: NotificationItemProps) {
  ...
  return (
    <div
      ...
      className={cn(
        'group flex gap-3 px-4 py-3 cursor-pointer transition-colors hover:bg-accent/50 border-b border-border last:border-b-0',
    ...
    >
      ...
      <button
        ...
        className="self-center size-7 rounded-md text-muted-foreground/60 opacity-0 group-hover:opacity-100 hover:bg-accent hover:text-destructive transition-all flex items-center justify-center"
      >
